...
segmented_im = np.load('out/segmented_im.npy')
...
np.save('out/distance_map_im', distance_map_im)
ps.io.to_vtk(distance_map_im, path='out/distance_map_im', divide=False,
