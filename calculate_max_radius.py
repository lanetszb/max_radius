...
def calculate_max_radius(segmented_im, voxel_size, input_output_im,
                         distance_map_name):
    # calculate distance map
    distance_map_im = ndimage.distance_transform_edt(segmented_im)
    distance_map_im *= voxel_size
    np.save(distance_map_name, distance_map_im)
    ps.io.to_vtk(distance_map_im, path=distance_map_name, divide=False,
    ...
    max_radius = Max_radius(distance_map_im, input_im, output_im,
